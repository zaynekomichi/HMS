        ...
        xhr.onload = function () {
          if (this.status==200) {
            ...
            var line = document.createElement("table");
               line.innerHTML ="<tr data-id="+res['id']+" class='get_date_id'><td>"+res['First_Name']+"</td><td>"+res['start_date']+"</td><td>"+res['start_time']+"</td><td>"+res['Phone_Number']+"</td><td>"+res['Gestation']+"</td><td>"+res['Reason']+"</td></tr>";
